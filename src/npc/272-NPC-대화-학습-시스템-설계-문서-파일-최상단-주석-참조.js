...
const NPC_TOPIC_SUMMARY_BANK = {
  '무기/전투':   ['무기와 전투에 대해 나름의 확고한 기준을 갖고 있다.', '전투 이야기가 나오면 평소보다 말이 많아진다.', '장비에 대한 조예가 깊어 보인다.', '실전 경험에서 우러나온 조언을 아끼지 않는다.', '무기 손질하는 법에 대해서도 한마디씩 거든다.', '싸움에 관한 이야기라면 눈빛부터 달라진다.', '전투 기술을 놓고 은근히 자부심을 드러낸다.', '위험한 상황에 대한 대비를 항상 강조한다.'],
  '퀘스트/의뢰': ['부탁할 일이 있는 듯 조심스럽게 운을 뗐다.', '의뢰에 관해서는 신중하게 말을 고른다.', '도움이 필요한 사정이 있어 보인다.', '섣불리 부탁하지 못하고 눈치만 살핀다.', '의뢰의 대가를 놓고 조심스럽게 저울질한다.', '믿을 만한 사람에게만 부탁하고 싶어하는 눈치다.', '일이 잘못될까 봐 걱정하는 기색이 역력하다.', '작은 부탁 하나에도 신중을 기하는 성격이다.'],
  '장소/지역':   ['이 근방 지리에 밝은 듯하다.', '특정 장소를 언급할 때 표정이 묘하게 변한다.', '가본 곳에 대한 이야기를 아끼지 않는다.', '길에 대한 이야기라면 막힘없이 술술 풀어놓는다.', '낯선 지명이 나와도 대충은 짐작하는 눈치다.', '어떤 장소에 대해서는 유독 말을 아낀다.', '지형지물을 손짓까지 섞어가며 설명한다.', '한 번 가본 곳은 오래도록 기억하는 편이다.'],
  '정보/비밀':   ['뭔가 아는 것이 있지만 쉽게 털어놓지 않는다.', '소문에 대해 조심스럽게 말을 흐린다.', '생각보다 많은 것을 알고 있는 눈치다.', '캐물을수록 오히려 입을 더 굳게 다문다.', '아는 것을 슬쩍 흘렸다가 이내 말을 돌린다.', '누군가 들을까 목소리를 낮춘다.', '확실치 않은 이야기는 함부로 옮기지 않으려 한다.', '묻지 않은 것까지 넌지시 암시하곤 한다.'],
  '거래/상점':   ['거래에는 나름의 원칙이 있는 듯하다.', '흥정을 즐기는 편인 것 같다.', '물건 보는 눈이 꽤 까다롭다.', '손해 보는 거래는 절대 하지 않으려 한다.', '값을 매길 때만큼은 눈빛이 예리해진다.', '단골에게는 은근히 후한 편이다.', '흥정이 길어져도 좀처럼 지치지 않는다.', '물건의 내력을 꼼꼼히 따지는 편이다.'],
  '관계/감정':   ['감정을 잘 숨기지 못하는 편이다.', '속마음을 조금씩 내비치기 시작했다.', '관계에 대해 신중한 태도를 보인다.', '가까워질수록 말수가 오히려 줄어든다.', '무심한 척해도 은근히 신경 쓰는 기색이다.', '마음을 여는 데 시간이 좀 걸리는 편이다.', '작은 배려에도 크게 마음이 움직이는 듯하다.', '자신의 감정을 에둘러 표현하는 편이다.'],
  '역사/전설':   ['옛이야기를 할 때 눈빛이 달라진다.', '역사에 대한 나름의 해석을 갖고 있다.', '오래된 이야기를 꽤 많이 알고 있는 듯하다.', '전설 속 인물을 마치 아는 사람처럼 이야기한다.', '오래된 기록과 구전을 곧잘 섞어 말한다.', '역사의 이면에 대해서도 나름의 생각이 있다.', '옛날 이야기를 꺼내면 시간 가는 줄 모른다.', '전해 들은 이야기에 자기 생각을 곁들이곤 한다.'],
  '일상/성격':   ['평소 성격이 대화 곳곳에서 드러난다.', '소소한 일상 이야기를 편하게 나눈다.', '특유의 말투와 태도가 느껴진다.', '사소한 일에도 자기만의 방식이 뚜렷하다.', '편안한 화제일수록 말이 술술 나온다.', '평범한 이야기 속에도 나름의 철학이 묻어난다.', '하루하루의 소소한 일들을 즐겁게 풀어놓는다.', '무심코 하는 말에서도 성격이 고스란히 드러난다.'],
};
